...
{
    public partial class Form4 : Form // Form1 繼承自 Windows Form 表單
    {
        // ====== 全域變數區 ======
        ...
        private void Form4_Load(object sender, EventArgs e)// 畫面載入事件
        {
            LoadImageFromGitHub();
        ...
        {
            // 起始金額（400~900 間的整十數）
            int value = random.Next(30, 51) * 10;
            currentMoney = value;
