...
{
    public partial class Form2 : Form // Form1 繼承自 Windows Form 表單
    {
        // ====== 全域變數區 ======
        ...
        private void Form2_Load(object sender, EventArgs e)// 畫面載入事件
        {
            LoadImageFromGitHub();
        ...
        {
            // 起始金額（400~900 間的整十數）
            int value = random.Next(10, 51) * 100;
            currentMoney = value;
