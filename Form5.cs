...
{
    public partial class Form5 : Form // Form1 繼承自 Windows Form 表單
    {
        // ====== 全域變數區 ======
        ...
        private void Form5_Load(object sender, EventArgs e)// 畫面載入事件
        {
            LoadImageFromGitHub();
            ...
            label12.Location = new Point(70, 20);
        ...
        {
            // 起始金額（400~900 間的整十數）
            int value = random.Next(50, 76) * 10;
            currentMoney = value;
