...
{
    public partial class Form8 : Form // Form1 繼承自 Windows Form 表單
    {
        // ====== 全域變數區 ======
        private int countdown = 90; // 遊戲倒數秒數初始值
        private int remainingTimeInSeconds = 90; // 剩餘時間（可與 countdown 整合）
        ...
        private void Form8_Load(object sender, EventArgs e)// 畫面載入事件
        {
            LoadImageFromGitHub();
        ...
        {
            // 起始金額（400~900 間的整十數）
            int value = random.Next(13, 48) * 100;
            currentMoney = value;
